...
class TestValidator extends Validator
{
    ...
    protected function markAttributeValidated($attr, $increaseBy = 1)
    {
        if (!isset($this->_validatedAttributes[$attr])) {
            ...
            $this->_validatedAttributes[$attr] = $this->_validatedAttributesarray($attr) + $increaseBy;
        }
    }

    public function countAttributeValidations($attr)
    {
        return isset($this->_validatedAttributes[$attr]) ? $this->_validatedAttributesarray($attr) : 0;
    }
