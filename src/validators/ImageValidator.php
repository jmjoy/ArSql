...
class ImageValidator extends FileValidator
{
    ...
    public function init()
    {
        ...
        if ($this->notImage === null) {
            $this->notImage = ArSql::t('yii', 'The file "{file}" is not an image.');
        }
        if ($this->underWidth === null) {
            $this->underWidth = ArSql::t('yii', 'The image "{file}" is too small. The width cannot be smaller than {limit, number} {limit, plural, one{pixel} other{pixels}}.');
        }
        if ($this->underHeight === null) {
            $this->underHeight = ArSql::t('yii', 'The image "{file}" is too small. The height cannot be smaller than {limit, number} {limit, plural, one{pixel} other{pixels}}.');
        }
        if ($this->overWidth === null) {
            $this->overWidth = ArSql::t('yii', 'The image "{file}" is too large. The width cannot be larger than {limit, number} {limit, plural, one{pixel} other{pixels}}.');
        }
        if ($this->overHeight === null) {
            $this->overHeight = ArSql::t('yii', 'The image "{file}" is too large. The height cannot be larger than {limit, number} {limit, plural, one{pixel} other{pixels}}.');
        }
    }
    ...
    protected function validateImage($image)
    {
        if (false === ($imageInfo = getimagesize($image->tempName))) {
            return array($this->notImage, array('file' => $image->name));
        }
        ...
        if ($this->minWidth !== null && $width < $this->minWidth) {
            return array($this->underWidth, array('file' => $image->name, 'limit' => $this->minWidth));
        }

        if ($this->minHeight !== null && $height < $this->minHeight) {
            return array($this->underHeight, array('file' => $image->name, 'limit' => $this->minHeight));
        }

        if ($this->maxWidth !== null && $width > $this->maxWidth) {
            return array($this->overWidth, array('file' => $image->name, 'limit' => $this->maxWidth));
        }

        if ($this->maxHeight !== null && $height > $this->maxHeight) {
            return array($this->overHeight, array('file' => $image->name, 'limit' => $this->maxHeight));
        }
    ...
    public function getClientOptions($model, $attribute)
    {
        ...
        if ($this->notImage !== null) {
            $options['notImage'] = $this->formatMessage($this->notImage, array(
                'attribute' => $label,
            ));
        }
        ...
        if ($this->minWidth !== null) {
            ...
            $options['underWidth'] = $this->formatMessage($this->underWidth, array(
                'attribute' => $label,
                'limit' => $this->minWidth,
            ));
        }
        ...
        if ($this->maxWidth !== null) {
            ...
            $options['overWidth'] = $this->formatMessage($this->overWidth, array(
                'attribute' => $label,
                'limit' => $this->maxWidth,
            ));
        }
        ...
        if ($this->minHeight !== null) {
            ...
            $options['underHeight'] = $this->formatMessage($this->underHeight, array(
                'attribute' => $label,
        ...
        if ($this->maxHeight !== null) {
            ...
            $options['overHeight'] = $this->formatMessage($this->overHeight, array(
                'attribute' => $label,
