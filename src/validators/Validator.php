...
class Validator
{
    ...
    public static $builtInValidators = array(
        'boolean' => 'arSql\validators\BooleanValidator',
        'captcha' => 'arSql\captcha\CaptchaValidator',
        'compare' => 'arSql\validators\CompareValidator',
        'date' => 'arSql\validators\DateValidator',
        'datetime' => array(
            'class' => 'arSql\validators\DateValidator',
        ...
        'default' => 'arSql\validators\DefaultValueValidator',
        'double' => 'arSql\validators\NumberValidator',
        'each' => 'arSql\validators\EachValidator',
        'email' => 'arSql\validators\EmailValidator',
        'exist' => 'arSql\validators\ExistValidator',
        'file' => 'arSql\validators\FileValidator',
        'filter' => 'arSql\validators\FilterValidator',
        'image' => 'arSql\validators\ImageValidator',
        'in' => 'arSql\validators\RangeValidator',
        'integer' => array(
            'class' => 'arSql\validators\NumberValidator',
            'integerOnly' => true,
        ),
        'match' => 'arSql\validators\RegularExpressionValidator',
        'number' => 'arSql\validators\NumberValidator',
        'required' => 'arSql\validators\RequiredValidator',
        'safe' => 'arSql\validators\SafeValidator',
        'string' => 'arSql\validators\StringValidator',
        'trim' => array(
            'class' => 'arSql\validators\FilterValidator',
            'filter' => 'trim',
            'skipOnArray' => true,
        ),
        'unique' => 'arSql\validators\UniqueValidator',
        'url' => 'arSql\validators\UrlValidator',
        'ip' => 'arSql\validators\IpValidator',
    );
    /**
    ...
    public function validate($value, &$error = null)
    {
        ...
        $params['attribute'] = ArSql::t('yii', 'the input value');
        if (is_array($value)) {
            $params['value'] = 'array()';
    ...
    {
        // if (ArSql::$app !== null) {
        //     return \ArSql::$app->getI18n()->format($message, $params, ArSql::$app->language);
        // }
        ...
        return ($placeholders === array()) ? $message : strtr($message, $placeholders);
    }
