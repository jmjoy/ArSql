...
class ExistValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message = ArSql::t('yii', '{attribute} is invalid.');
        }
    }
    ...
    protected function validateValue($value)
    {
        ...
        $query = $this->createQuery($this->targetClass, array($this->targetAttribute => $value));

        if (is_array($value)) {
            if (!$this->allowArray) {
                return array($this->message, array());
            }
            return $query->count("DISTINCT [[$this->targetAttribute]]") == count($value) ? null : array($this->message, array());
        } else {
            return $query->exists() ? null : array($this->message, array());
        }
    }
