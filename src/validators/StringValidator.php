...
class StringValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if (is_array($this->length)) {
            if (isset($this->lengtharray(0))) {
                $this->min = $this->lengtharray(0);
            }
            if (isset($this->lengtharray(1))) {
                $this->max = $this->lengtharray(1);
            }
            $this->length = null;
        }
        if ($this->encoding === null) {
            $this->encoding = ArSql::$app->charset;
        }
        if ($this->message === null) {
            $this->message = ArSql::t('yii', '{attribute} must be a string.');
        }
        if ($this->min !== null && $this->tooShort === null) {
            $this->tooShort = ArSql::t('yii', '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.');
        }
        if ($this->max !== null && $this->tooLong === null) {
            $this->tooLong = ArSql::t('yii', '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.');
        }
        if ($this->length !== null && $this->notEqual === null) {
            $this->notEqual = ArSql::t('yii', '{attribute} should contain {length, number} {length, plural, one{character} other{characters}}.');
        }
    }
    ...
    public function validateAttribute($model, $attribute)
    {
        ...
        if ($this->min !== null && $length < $this->min) {
            $this->addError($model, $attribute, $this->tooShort, array('min' => $this->min));
        }
        if ($this->max !== null && $length > $this->max) {
            $this->addError($model, $attribute, $this->tooLong, array('max' => $this->max));
        }
        if ($this->length !== null && $length !== $this->length) {
            $this->addError($model, $attribute, $this->notEqual, array('length' => $this->length));
        }
    }
    ...
    public function getClientOptions($model, $attribute)
    {
        ...
        $options = array(
            'message' => $this->formatMessage($this->message, array(
                'attribute' => $label,
            )),
        );
        ...
        if ($this->min !== null) {
            ...
            $options['tooShort'] = $this->formatMessage($this->tooShort, array(
                'attribute' => $label,
                'min' => $this->min,
            ));
        }
        if ($this->max !== null) {
            ...
            $options['tooLong'] = $this->formatMessage($this->tooLong, array(
                'attribute' => $label,
                'max' => $this->max,
            ));
        }
        if ($this->length !== null) {
            ...
            $options['notEqual'] = $this->formatMessage($this->notEqual, array(
                'attribute' => $label,
                'length' => $this->length,
            ));
        }
