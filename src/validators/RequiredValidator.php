...
class RequiredValidator extends Validator
{
    ...
    public function init()
    {
        ...
        if ($this->message === null) {
            $this->message = $this->requiredValue === null ? ArSql::t('yii', '{attribute} cannot be blank.')
                           : ArSql::t('yii', '{attribute} must be "{requiredValue}".');
        }
    }
    ...
    public function getClientOptions($model, $attribute)
    {
        ...
        $options['message'] = $this->formatMessage($options['message'], array(
